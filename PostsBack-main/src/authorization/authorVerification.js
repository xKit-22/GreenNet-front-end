...
var configKey = process.env.JWT_KEY;
var secret = 'secret';
exports.default = (function (req, res, next) {
    var userRepository = (0, typeorm_1.getRepository)(User_1.User);
    var postRepository = (0, typeorm_1.getRepository)(Post_1.Post);
    var commentRepository = (0, typeorm_1.getRepository)(Comment_1.Comment);
