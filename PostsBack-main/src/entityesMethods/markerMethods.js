...
var Marker_1 = require("../entity/Marker");
...
markerRouter.get("/", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, markerRepository.find()];
                case 1:
                    markers = _a.sent();
...
markerRouter.delete("/deleteMarker/:id", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var marker, results;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
markerRouter.post("/", function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, markerRepository.create(req.body)];
                case 1:
                    marker = _a.sent();
...
exports.default = (function () {
    markerRepository = (0, typeorm_1.getRepository)(Marker_1.Marker);
    return markerRouter;
});
